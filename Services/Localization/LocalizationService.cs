    ...
    public class LocalizationService : ILocalizationService
    {
        ...
        private void InitializeTranslations()
        {
            var dict_en = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Status_Item_Added"] = "Added '{0}' successfully.",
                ["Status_Item_Updated"] = "Updated '{0}' successfully.",
                ...
                ["Cover_Art"] = "Cover Art",
                ["Status_Items_Dropped"] = "Added {0} dropped item(s).",
                ["SteamGrid_Save"] = "💾 Save Key",
                ["SteamGrid_Saved"] = "API key saved successfully.",
                ["SteamGrid_Sub"] = "Enter SteamGridDB API key to automatically fetch 600x900 poster cover art for games.",
                ["SteamGrid_Title"] = "🎮 SteamGridDB Game Covers",
                ["TrayClipboard"] = "Clipboard History",
                ["TrayExit"] = "Exit",
            ...
            var dict_tr = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["MsgItemAdded"] = "eklendi.",
                ["MsgItemDeleted"] = "silindi.",
                ["MsgItemUpdated"] = "güncellendi.",
                ...
                ["Status_Item_Added"] = "'{0}' başarıyla eklendi.",
                ["Status_Item_Updated"] = "'{0}' başarıyla güncellendi.",
                ...
                ["Cmd_Calculator"] = "Hesap Makinesi",
                ["Cover_Art"] = "Kapak Resmi",
                ["Status_Items_Dropped"] = "{0} adet sürüklenen öğe eklendi.",
                ["SteamGrid_Save"] = "💾 Anahtarı Kaydet",
                ["SteamGrid_Saved"] = "API anahtarı başarıyla kaydedildi.",
                ["SteamGrid_Sub"] = "Oyunlar için otomatik 600x900 afiş kapakları almak üzere SteamGridDB API anahtarınızı girin.",
                ["SteamGrid_Title"] = "🎮 SteamGridDB Oyun Kapakları",
                ["TrayClipboard"] = "Pano Geçmişi",
                ["TrayExit"] = "Çıkış",
